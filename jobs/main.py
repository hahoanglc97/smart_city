...
BIRMINGHAM_COORDINATES = {"latitude": 52.4861, "longitude": -1.8904}

# Caculate movement information
LATITUDE_INCREMENT = (
    BIRMINGHAM_COORDINATES["latitude"] - LONDON_COORDINATES["longitude"]
) / 100
LONGITUDE_INCREMENT = (
...
def simulate_vehicle_movement():
    ...
    start_location["latitude"] += random.uniform(-0.0005, 0.005)
    start_location["longitude"] += random.uniform(-0.0005, 0.005)
...
def simulate_journey(producer, device_id):
    while True:
        ...
        if (
            ...
            print("Vehicle has reached the BIRMINGHAM. Simulation ending...")
            break
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, "Vehicle-Journey")
